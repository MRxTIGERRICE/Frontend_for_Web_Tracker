...
<template>
  <div>
    <p class="title mt-0">The Blacklist(Sites not allowed to access/browse)</p>
    <p class="description">Here you can add or remove urls,websites which you dont want to access/be away from!</p>
    <!-- <p class="description">
      {{ t('limitsTip.message') }}
    </p> -->
...
<script lang="ts" setup>
import ListWithTimeComponent from '../components/Blacklist1.vue';
